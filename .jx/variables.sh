...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-terraform/terraform-jx-azure/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/terraform-jx-azure:0.7.2'
