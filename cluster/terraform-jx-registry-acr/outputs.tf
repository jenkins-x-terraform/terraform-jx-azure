...
output "resource_group_name" {
  value = azurerm_container_registry.acr[0].resource_group_name == null ? azurerm_container_registry.acr[0].resource_group_name : data.azurerm_container_registry.acr_existing[0].resource_group_name
}
