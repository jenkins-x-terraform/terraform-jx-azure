...
output "resource_group_name" {
  value = var.external_registry_url != "" ? "" : var.use_existing_acr_resource_group_name == null ? azurerm_container_registry.acr[0].resource_group_name : data.azurerm_container_registry.acr_existing[0].resource_group_name
}
