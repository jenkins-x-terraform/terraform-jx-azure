...
resource "azurerm_resource_group" "acr" {
  count    = var.acr_enabled == true && var.external_registry_url == "" && var.use_existing_acr_name == null ? 1 : 0
...
data "azurerm_container_registry" "acr_existing" {
  count = var.acr_enabled == true && var.use_existing_acr_name != null ? 1 : 0
...
resource "azurerm_role_assignment" "acrpull" {
  count                = var.acr_enabled == true && var.external_registry_url == "" ? 1 : 0
